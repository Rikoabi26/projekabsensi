<form action="/cuti/{{$cuti->kode_cuti}}/update" method="POST">
    @csrf
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cuti->nama_cuti}}" name="nama_cuti" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cuti->jml_hari}}" name="jml_hari" id="jml_hari"
