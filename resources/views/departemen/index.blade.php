                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="edit btn btn-info btn-sm"
                                                                style="margin-right: 5px" kode_dept="{{ $d->kode_dept }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" name="nama_dept" class="form-control"
...
@push('myscript')
    <script>
        ...
        document.getElementById('kode_dept').addEventListener('input', function() {
