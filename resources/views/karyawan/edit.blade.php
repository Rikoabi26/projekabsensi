<form action="/karyawan/{{ $karyawan->email }}/update" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $karyawan->email }}" name="email" class="form-control"
