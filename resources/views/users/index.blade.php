                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- memberi akses hanya pada admin utama --}}
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="edit btn btn-info btn-sm"
                                                                style="margin-right: 5px" id_user="{{ $d->id }}">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="nama_user" value="" name="nama_user"
                                        class="form-control" placeholder="Nama Users" required>
                                </div>
                            </div>
                        </div>
