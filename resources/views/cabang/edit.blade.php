    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cabang->kode_cabang}}" id="kode_cabang" name="kode_cabang"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cabang->nama_cabang}}" name="nama_cabang" id="nama_cabang"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cabang->lokasi_cabang}}" name="lokasi_cabang" id="lokasi_cabang"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{$cabang->radius_cabang}}" name="radius_cabang" id="radius_cabang"
